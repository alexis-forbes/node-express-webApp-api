...
exports.getAllTours = async (req, res) => {
  try {
    ...
    // a. we create a route in tourRoutes
    ...
    res.status(400).json({
      status: 'failed',
      message: `Could not get tours! ${err.message}`,
    });
  }
};
...
exports.getOneTour = async (req, res) => {
  try {
    ...
    res.status(400).json({
      status: 'failed',
      message: `Could not get the tour! ${err.message}`,
    });
  }
};
...
exports.createTour = async (req, res) => {
  try {
    ...
    //err if required fields are missing
    res.status(400).json({
      status: 'failed',
...
exports.deleteTour = async (req, res) => {
  try {
    ...
    res.status(400).json({
      status: 'failed',
      message: `Could not delete the tour! ${err.message}`,
    });
  }
};
...
exports.getTourStats = async (req, res) => {
  try {
    ...
    res.status(400).json({
      status: 'failed',
      message: `Could not get the tour statistic! ${err.message}`,
    });
  }
};
